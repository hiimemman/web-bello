...
<body>
    ...
    <nav class="fixed bg-white dark:bg-gray-900 dark:text-white top-0 left-0 right-0 shadow-lg z-10">
        <div class="container mx-auto flex flex-wrap max-w-7xl items-center justify-between py-10 lg:px-8">
            ...
            <div class="hidden lg:flex lg:gap-x-12" id="navbar-default">
                ...
                <a href="/web-bello/pages/user-index.php#contact" class="nav-link text-sm font-semibold leading-6 text-gray-900 dark:text-white">Contacts</a>
                <a href="../api/login/logout.php" class="nav-link text-sm font-semibold leading-6 hover:text-gray-900 text-gray-400 dark:text-gray-400">Sign
                    out</a>
                <div class="relative" x-data="{ open: false }">
                    <button type="button" class="text-sm font-semibold leading-6 text-white flex items-center focus:outline-none" @click="open = !open" aria-expanded="false" aria-haspopup="true">
                        <span>
                            <svg class="h-6 w-6 text-gray-900 dark:text-gray-900 hover:text-gray-600 dark:hover:text-gray-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">

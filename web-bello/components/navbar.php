            ...
            <div class="hidden lg:flex lg:gap-x-12">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" class="absolute right-0 py-2 w-48 bg-white dark:bg-gray-900 rounded-md shadow-lg z-10" :class="{ 'hidden': !open }" id="dropdownMenu">
                        ...
                        <a href="../api/login/logout.php" class="bg-blue-100 dropdown-item text-sm font-semibold leading-6 text-gray-900 dark:text-white block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-800">
                            <span>Sign out</span>
                        </a>
                    </div>
                </div>

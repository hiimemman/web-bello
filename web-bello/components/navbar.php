...
<body>
    ...
    <nav class="fixed top-0 left-0 right-0 shadow-lg z-10 bg-white dark:bg-gray-900">
        <div class="container mx-auto flex flex-wrap max-w-7xl items-center justify-between py-10 lg:px-8">
            ...
            <div class="hidden lg:flex lg:gap-x-12" id="navbar-default">
                <a href="/web-bello/pages/user-index.php"
                    class="nav-link text-sm font-semibold leading-6 text-white">Home</a>
                <a href="/web-bello/pages/user-index.php#about"
                    class="nav-link text-sm font-semibold leading-6 text-white">About Us</a>
                <a href="/web-bello/pages/user-index.php#contact"
                    class="nav-link text-sm font-semibold leading-6 text-white">Contacts</a>
                <a href="../api/login/logout.php"
                    class="nav-link text-sm font-semibold leading-6 hover:text-gray-900 text-gray-400 dark:text-white dark:hover:text-white">Sign
                    out</a>

        ...
        <div class="container mx-auto flex flex-wrap max-w-7xl items-center justify-between py-10 lg:px-8">
            ...
            <div class="hidden lg:flex lg:gap-x-12" id="navbar-default">
                <a href="/web-bello/pages/user-index.php"
                    class="nav-link text-sm font-semibold leading-6 text-white dark:text-gray-900">Home</a>
                <a href="/web-bello/pages/user-index.php#about"
                    class="nav-link text-sm font-semibold leading-6 text-white dark:text-gray-900">About Us</a>
                <a href="/web-bello/pages/user-index.php#contact"
                    class="nav-link text-sm font-semibold leading-6 text-white dark:text-gray-900">Contacts</a>
                <a href="../api/login/logout.php"
                    class="nav-link text-sm font-semibold leading-6 hover:text-gray-900 text-gray-400 dark:text-gray-400">Sign
                    out</a>
                <div class="relative" x-data="{ open: false }">
                    <button type="button"
                        ...
                        <span>
                            <svg class="h-6 w-6 hover:text-gray-600 dark:hover:text-gray-400" fill="none"

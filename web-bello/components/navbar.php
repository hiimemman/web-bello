...
<body>
    ...
    <nav class="fixed bg-white dark:bg-gray-900 top-0 left-0 right-0 shadow-lg z-10">
        <div class="container mx-auto flex flex-wrap max-w-7xl items-center justify-between py-10 lg:px-8">
            ...
            <div class="flex lg:hidden px-6">
                <button data-collapse-toggle="navbar-default" type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700" aria-controls="navbar-default" aria-expanded="false" @click="open = !open">
            ...
            <!-- Nav Links -->
            <div class="hidden lg:flex lg:gap-x-12" id="navbar-default" x-data="{ open: false }" :class="{ 'flex': open, 'hidden': !open }" @click.away="open = false">
    ...
    <div class="block lg:hidden bg-white dark:bg-gray-900" role="dialog" aria-modal="true" id="menu">
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/10">
                        <div class="space-y-2 py-6">
                            <a href="" class="-mx-3 text-sm font-semibold leading-6 text-gray-900 dark:text-white block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-800">
                                Home
                            </a>
                            <a href="" class="-mx-3 text-sm font-semibold leading-6 text-gray-900 dark:text-white block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-800">
                                About us

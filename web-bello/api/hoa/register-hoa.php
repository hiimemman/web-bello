...
if (mysqli_num_rows($emailCheckResult) > 0) {
    ...
    exit(json_encode(array("responseStatus" => 'error', "responseMessage" => 'Email already exists!')));
      ...
      try {
                      ...
                      <table role='presentation' border='0' cellpadding='0' cellspacing='0' width='100%'>
                        ...
                        <tr>
                          <td style='text-align: center; bordeR: 1px solid rgba(0,0,0,.05);max-width: 50%;margin: 0 auto; padding: 2em;'> 	
                              ...
                              <h3 style='color: black;'>Hi, $Firstname $Lastname!</h3><p style='color: black;'>Thanks for visiting web belo,<br>Use this PASSWORD to  Sign up on your user account on Web bello.</p><p style='color: black;'>Remember, to change your password as soon as possible.</p>
        ...
        if (!$emailExists) {
        $sql = "INSERT INTO `tbl_hoa` (`firstname`,`lastname`,`email`,`address`,`password`,`role`,`contact`) VALUES ('$Firstname','$Lastname','$Email','$Address','$Password','$Role','$Contact');";

    ...
    <section class="border-t-4 border-sky-300 mb-10">
        <div class="container mx-auto grid gap-8 lg:grid-cols-1 px-24 mt-10">
            <article
                ...
                <form>
                    <div
                        class="py-2 px-4 mb-4 bg-white rounded-xl border-2 border-gray-400 dark:bg-gray-800 dark:border-gray-700">
                        <label for="comment" class="sr-only">Your comment</label>
                        <textarea id="comment" rows="3"
                            class="px-0 w-full text-md text-gray-900 border-0 focus:ring-0 focus:outline-none dark:text-white dark:placeholder-gray-400 dark:bg-gray-800"
                            placeholder="Write a comment..." required></textarea>
                    </div>
                    <button type="submit" id="postButton"
                        class="text-white bg-sky-800 cursor-not-allowed focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-6 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                        disabled>
                        Post comment
                    </button>
                </form>

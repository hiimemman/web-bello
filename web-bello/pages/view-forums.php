        ...
        <div class="container mx-auto grid gap-8 lg:grid-cols-1 px-24 mt-10">
            <article class="p-12 mx-20 bg-white rounded-lg border border-gray-200 shadow-md">
                <div class="flex justify-between items-center mb-5 text-gray-500">
                    <span class="bg-orange-100 text-orange-700 text-md font-medium inline-flex items-center px-2.5 py-0.5 rounded">
                        Forums
                    </span>
                ...
                <a id="readMoreLink" href="#" class="mb-5 inline-flex items-center font-medium text-lg text-primary-600 hover:underline">
                    See more...
                </a>
                <!-- Image -->
                ...
                <form>
                    <div class="py-2 px-4 mb-4 bg-white rounded-xl border-2 border-gray-400">
                        ...
                        <textarea id="comment" rows="3" class="px-0 w-full text-md text-gray-900 border-0 focus:ring-0 focus:outline-none" placeholder="Write a comment..." required></textarea>
                    </div>
                    <button type="submit" id="postButton" class="text-white bg-sky-800 cursor-not-allowed focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-6 focus:outline-none" disabled>
                        Post comment
                    </button>
                </form>

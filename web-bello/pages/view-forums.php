...
<body>
    ...
    <section class="border-t-4 border-sky-300 mb-10">
        <div class="container mx-auto grid gap-8 lg:grid-cols-1 px-24 mt-10">
            <article class="p-12 mx-20 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-between items-center mb-5 text-gray-500">
                    <span class="bg-orange-100 text-orange-700 text-md font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800">
                        Forums
                    </span>
                ...
                <a id="readMoreLink" href="#" class="mb-5 inline-flex items-center font-medium text-lg text-primary-600 dark:text-primary-500 hover:underline">
                    See more...
                </a>
                <!-- Image -->
                ...
                <!-- Comments -->
                <form>
                    <div class="py-2 px-4 mb-4 bg-white rounded-xl border-2 border-gray-400 dark:bg-gray-800 dark:border-gray-700">
                        <label for="comment" class="sr-only">Your comment</label>
                        <textarea id="comment" rows="3" class="px-0 w-full text-md text-gray-900 border-0 focus:ring-0 focus:outline-none dark:text-white dark:placeholder-gray-400 dark:bg-gray-800" placeholder="Write a comment..." required></textarea>
                    </div>
                    <button type="submit" id="postButton" class="text-white bg-sky-800 cursor-not-allowed focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-6 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" disabled>
                        Post comment
                    </button>
                </form>
                ...
                <article class="p-6 mb-6 text-base border-t border-gray-200 bg-white dark:bg-gray-900">
                    ...
                    <footer class="flex justify-between items-center mb-2">
                        <div class="flex items-center">
                            <p class="inline-flex items-center mr-3 text-md font-medium text-gray-900 dark:text-white">
                                Nikola Butler
                            </p>

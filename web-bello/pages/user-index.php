    ...
    <section class="bg-sky-50">
        <div class="container px-6 py-16 mx-auto text-center">
            ...
            <div class="flex justify-center mt-10">
                <img class="object-cover w-full h-96 rounded-xl lg:w-4/5 hover:shadow-lg"
    ...
    <section class="bg-gray-100" id="about">
        <div class="container px-6 py-16 mx-auto">
            ...
            <div class="flex flex-wrap items-stretch md:items-center mt-8">
                <div class="w-full md:w-1/2 hover:shadow-lg">
        ...
        <div class="container px-6 py-16 mx-auto">
            ...
            <div class="flex flex-col md:flex-row mt-12 items-center">
                <div class="w-full md:w-1/2">
                    <div class="max-w-lg mx-auto">
                        <div class="bg-white rounded-lg shadow-md p-6 mb-6 hover:shadow-lg">

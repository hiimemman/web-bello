    ...
    <section class="bg-sky-50">
        <div class="container px-6 py-16 mx-auto text-center">
            ...
            <div class="flex justify-center mt-10">
                <img class="object-cover w-full h-96 rounded-xl lg:w-4/5 hover:shadow-xl transition-shadow" src="/web-bello/images/banner-1.png" />
            </div>
        </div>
    </section>
    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="flex flex-wrap -m-4">
                <div class="p-4 md:w-1/2 w-full hover:shadow-xl transition-shadow">
                    <div class="h-full bg-gray-100 p-8 rounded-xl">

            ...
            <div class="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:gap-x-16">
                <div class="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right lg:text-left">
                    ...
                    <p class="mt-4 text-gray-700 tracking-wide text-md">
                        ...
                        Together, let's create a vibrant community. Thank you for your cooperation!<br />

                        We appreciate your attention to your account and ensuring that all dues are paid promptly. Your
                        ...
                        to us. Thank you for your continued support!
                    </p>
                ...
                <div class="grid grid-cols-2 gap-4 sm:grid-cols-2">
                    <a class="block rounded-xl border border-gray-300 p-4 shadow-sm hover:shadow-xl transition-shadow focus:outline-none focus:ring grid-box" href="#">
                    ...
                    <a class="block rounded-xl border border-gray-300 p-4 shadow-sm hover:shadow-xl transition-shadow focus:outline-none focus:ring grid-box" href="/web-bello/pages/update-profile.php">
                        <span class="flex items-center justify-center rounded-lg p-3">
                            <svg class="h-12 w-12" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">

        ...
        <div class="container px-6 py-16 mx-auto text-center">
            <div class="max-w-lg mx-auto">
                <h1 class="text-3xl font-semibold text-gray-800 dark:text-white lg:text-4xl">Welcome to Palazzo Bello
                    Subdivision!</h1>
                <p class="mt-6 text-gray-500 dark:text-gray-300 text-center w-full">Discover a remarkable residential
                    experience in the
            ...
            <div class="flex justify-center mt-10">
                <img class="object-cover w-full h-96 rounded-xl lg:w-4/5" src="/web-bello/images/banner-1.png" />
            </div>
        </div>
    </section>

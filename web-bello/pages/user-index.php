    ...
    <section class="bg-sky-50">
        <div class="container px-6 py-16 mx-auto text-center">
            ...
            <div class="flex justify-center mt-10">
                <img class="object-cover w-full h-96 rounded-xl lg:w-4/5 hover:shadow-xl transition-shadow"
                    src="/web-bello/images/banner-1.png" />
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:gap-x-16">
                ...
                <div class="grid grid-cols-2 gap-4 sm:grid-cols-2">
                    <a class="block rounded-xl border border-gray-300 p-4 shadow-sm hover:shadow-xl transition-shadow focus:outline-none focus:ring grid-box"
                        ...
                        <p class="mt-2 font-medium tracking-wider text-center">
                            MANAGE DUES
                        </p>
                    </a>
                    ...
                    <a class="block rounded-xl border border-gray-300 p-4 shadow-sm hover:shadow-xl transition-shadow focus:outline-none focus:ring grid-box"
                        ...
                        <p class="mt-2 text-md font-medium tracking-wider text-center">
                            UPDATE PROFILE
                        </p>
                    </a>

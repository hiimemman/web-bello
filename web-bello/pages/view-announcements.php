        ...
        <div class="container mx-auto grid gap-8 lg:grid-cols-1 px-24 mt-10">
            <article class="p-12 mx-20 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <form>
                    ...
                    <button type="submit" id="postButton" class="text-white bg-sky-950 cursor-not-allowed focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" disabled>
                        Post comment
                    </button>
                </form>

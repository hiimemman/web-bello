                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="password" class="input-field block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-gray-200 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                <div class="form-group">
                                    <label for="password1" class="label block text-sm font-medium leading-6 text-gray-900">Confirm
                                        password</label>
                                    <input type="text" name="password1" class="input-field block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-gray-200 sm:text-sm sm:leading-6">
                                </div>
                            </div>

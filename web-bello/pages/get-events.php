...
<a href="#" id="previousBtn" class="inline-flex items-center px-4 py-2 mr-3 text-sm font-medium text-white bg-green-500 border border-gray-300 rounded-lg hover:bg-green-600">
  <svg aria-hidden="true" class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" d="M7.707 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l2.293 2.293a1 1 0 010 1.414z" clip-rule="evenodd"></path>
  </svg>
  Previous
</a>
<a href="#" id="nextBtn" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-green-500 border border-gray-300 rounded-lg hover:bg-green-600">
  Next
...
<style>
 ...
 /* background-color: #68d391;  Replace with your desired color */
  color: white;
}

.pagination-container a:hover {
 /* background-color: #48bb78; /* Replace with the hover color */
}

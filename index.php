...
<body>
    ...
    <section class="bg-gray-50 custom-bg">
        <div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center ">
            <div class="mx-auto max-w-xl text-center rounded-lg shadow bg-white opacity-5 px-16 py-20">
                <h1 class="landing-content mb-4 text-4xl font-extrabold tracking-tight text-gray-800">

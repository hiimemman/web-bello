        ...
        <div class="mx-auto max-w-screen-xl px-4 pt-8 pb-4 mt-24 lg:flex lg:h-screen lg:items-center">
            <div
                ...
                <div class="mt-8 flex flex-wrap justify-center gap-4">
                    <a class="group relative inline-flex items-center overflow-hidden rounded hover:rounded hover:border-2 hover:border-sky-950 hover:bg-white bg-sky-950 px-12 py-3 text-white hover:text-gray-900 focus:outline-none focus:ring active:bg-indigo-500"
                    ...
                    <a class="group relative inline-flex items-center overflow-hidden rounded border-2 border-sky-950 hover:bg-sky-950 px-14 py-3 text-gray-900 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"

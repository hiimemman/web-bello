...
<body>
    <div class="container">
        <section class="bg-white dark:bg-gray-900 custom-bg">
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto grid-cols-1 md:grid-cols-12">
                <div class="mr-auto place-self-center md:col-span-7">
                    ...
                    <p class="landing-content max-w-2xl mb-6 font-medium text-white md:mb-8 md:text-lg lg:text-xl dark:text-white">
                        The ultimate hub for homeowners to stay connected and informed! With Web-Bello, you can easily connect
                        with your neighbors, stay informed on the latest news and events, and receive important alerts and
                        notifications.
                    </p>
                </div>
                <div class="landing-content md:mt-0 md:col-span-5 md:flex">
                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <div class="space-y-4 md:space-y-6">
                                ...
                                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Or <a href="/web-bello/pages/index.php" class="custom-text-btn">sign in here</a> as administrator.
                                </p>
                            </div>
                        </div>
                    </div>

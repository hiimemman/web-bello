...
<body>
    ...
    <section class="bg-gray-50 custom-bg">
        <div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center ">
            <div class="mx-auto max-w-xl text-center rounded-lg shadow bg-white px-16 py-20">
                <h1 class="landing-content mb-4 text-5xl font-extrabold tracking-tight text-gray-800">
                    Welcome to Web-Bello!
                </h1>

                <p class="mt-4 sm:text-xl/tight text-gray-800 font-medium tracking-wide">
                ...
                <div class="mt-8 flex flex-wrap justify-center gap-4">
                    <a class="block w-full rounded bg-sky-950 px-12 py-3 text-sm font-medium text-white shadow hover:bg-sky-700 focus:outline-none focus:ring sm:w-auto lg:w-auto xl:w-auto" href="/get-started">
                        Resident
                    </a>

                    <a class="block w-full rounded bg-sky-950 px-12 py-3 text-sm font-medium text-white shadow hover:bg-sky-700 focus:outline-none focus:ring sm:w-auto lg:w-auto xl:w-auto" href="/about">
                        Admin
                    </a>
                </div>
            </div>

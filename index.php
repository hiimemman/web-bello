    ...
    <section class="bg-gray-50 custom-bg">
        <div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
            <div class="mx-auto max-w-xl text-center bg-white">
                <h1 class="landing-content mb-4 text-6xl font-extrabold tracking-tight text-dark-900">
                    Welcome to Web-Bello!
                </h1>

                <p class="mt-4 sm:text-xl/tight text-dark-800 font-medium tracking-wide">
